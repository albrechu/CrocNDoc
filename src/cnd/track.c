...
const track_t g_crocodileCacophony = 
{
    ...
    .notes       = 
    {
        D4,	                        CROCODILE_CACOPHONY_SHORT,
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
					 D4,	                        CROCODILE_CACOPHONY_SPEED,
					 D4,	                        CROCODILE_CACOPHONY_SPEED,
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
	  0x80 + D4,	0x80 + A5, D6,  CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,	0x80 + AS5, DS6,CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,	0x80 + B6, DS6, CROCODILE_CACOPHONY_SPEED,
					 ...
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
		0x80 + D4,	0x80 + C6, E6,  CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,	0x80 + CS6, F6, CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,	0x80 + D6, F6,  CROCODILE_CACOPHONY_SHORT,
									  0x80 + D6, FS6, CROCODILE_CACOPHONY_SHORT,
					 ...
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
		0x80 + D4,	0x80 + B5, E6,  CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,	0x80 + C6, G6,  CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,	0x80 + E6, GS6, CROCODILE_CACOPHONY_SPEED,
					 ...
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
					 D4,	                        CROCODILE_CACOPHONY_SHORT,
		0x80 + D4,	0x80 + D6, FS6, CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,	0x80 + DS6, G6, CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,	0x80 + E6, G6,  CROCODILE_CACOPHONY_SHORT,
									  0x80 + E6, GS6, CROCODILE_CACOPHONY_SHORT,

		0x80 + G3,	0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
					 G3,													CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + G6, AS6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G4,  0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
					 G3,													CROCODILE_CACOPHONY_SHORT,
										0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G4,  0x80 + G6, AS6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3,  0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
	  ...
	  0x80 + G3,  0x80 + G6, AS6, CROCODILE_CACOPHONY_SHORT,
		...
		0x80 + G3,	0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
					 G3,													CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + FS6, A6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G4,  0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
					 G3,													CROCODILE_CACOPHONY_SHORT,
										0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G4,  0x80 + FS6, A6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3,  0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + FS6, A6, CROCODILE_CACOPHONY_SHORT,
		...
		0x80 + G3,	0x80 + DS6, AS6, CROCODILE_CACOPHONY_SHORT,
																		AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, AS6, CROCODILE_CACOPHONY_SHORT,
					 G3,													CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + AS5, AS6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G4,  0x80 + DS6, AS6, CROCODILE_CACOPHONY_SHORT,
										               AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,								 AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,				         AS5,	CROCODILE_CACOPHONY_SHORT,
										               AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G4,  0x80 + DS6, AS6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3,  0x80 + D6, AS6, CROCODILE_CACOPHONY_SHORT,
										               AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + DS6, AS6, CROCODILE_CACOPHONY_SHORT,
										               AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, AS6, CROCODILE_CACOPHONY_SHORT,
					 G3,													CROCODILE_CACOPHONY_SHORT,
		0x80 + G4,  0x80 + AS5, AS6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3,  0x80 + DS6, AS6, CROCODILE_CACOPHONY_SHORT,
										                AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,                 AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,        AS5,          CROCODILE_CACOPHONY_SHORT,
										               AS6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G4,  0x80 + F6, AS6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3,                 AS6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, AS6, CROCODILE_CACOPHONY_SHORT,

		0x80 + G3,	0x80 + DS6, A6, CROCODILE_CACOPHONY_SHORT,
																		A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, A6, CROCODILE_CACOPHONY_SHORT,
					 G3,													CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + A5, A6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G4,  0x80 + DS6, A6, CROCODILE_CACOPHONY_SHORT,
																		A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, A6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,								 A6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,				 A5,					CROCODILE_CACOPHONY_SHORT,
										               A6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G4,  0x80 + DS6, A6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3,  0x80 + D6, A6, CROCODILE_CACOPHONY_SHORT,
										               A6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,  0x80 + DS6, A6, CROCODILE_CACOPHONY_SHORT,
										               A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, A6, CROCODILE_CACOPHONY_SHORT,
					 G3,													CROCODILE_CACOPHONY_SHORT,
		0x80 + G4,  0x80 + A5, A6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3,  0x80 + DS6, A6, CROCODILE_CACOPHONY_SHORT,
										                A6, CROCODILE_CACOPHONY_SHORT,
										0x80 + D6, A6, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3,                 A6, CROCODILE_CACOPHONY_SHORT,
		...
		0x80 + A3,	0x80 + D5,  A5, CROCODILE_CACOPHONY_PAUSE2,
		...
		0x80 + A3,  0x80 + D5,  A5, CROCODILE_CACOPHONY_SHORT,
										0x80 + D5,  A5, CROCODILE_CACOPHONY_SHORT,
		0x80 + F3,	0x80 + D5,  A5, CROCODILE_CACOPHONY_SPEED,
		0x80 + D3,	0x80 + D5,  A5, CROCODILE_CACOPHONY_SPEED2,
		...
		0x80 + G3,	0x80 + CS5, A5, CROCODILE_CACOPHONY_SPEED,
					 ...
					 G3,									        CROCODILE_CACOPHONY_HALF,
					 F3,									        CROCODILE_CACOPHONY_SPEED,
		0x80 + E3,	0x80 + CS5, A5, CROCODILE_CACOPHONY_SPEED,
		0x80 + D3,  0x80 + D5,  A5, CROCODILE_CACOPHONY_SPEED,

			     G3,                          CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,									D6, CROCODILE_CACOPHONY_SPEED,
			     FS4,                         CROCODILE_CACOPHONY_SPEED,
		0x80 + D4,									D6, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3,                  D6, CROCODILE_CACOPHONY_PAUSE2,
			     DS4,                         CROCODILE_CACOPHONY_SHORT,
			     FS4,                         CROCODILE_CACOPHONY_SPEED,
			     FS4,                         CROCODILE_CACOPHONY_SPEED,

		0x80 + DS4,									C6, CROCODILE_CACOPHONY_SHORT,
																		AS5, CROCODILE_CACOPHONY_SHORT,
		0x80 + G3, 									A5, CROCODILE_CACOPHONY_SPEED,
			     CS4,                         CROCODILE_CACOPHONY_SPEED,
		0x80 + FS4,						  		AS5,CROCODILE_CACOPHONY_SPEED,
		0x80 + CS4,									A5, CROCODILE_CACOPHONY_SPEED,
		0x80 + G3, 									AS5, CROCODILE_CACOPHONY_SHORT,
		        D4,													CROCODILE_CACOPHONY_SHORT,
		0x80 + FS4,									A5, CROCODILE_CACOPHONY_SPEED,
		0x80 + FS4,									G5, CROCODILE_CACOPHONY_SPEED2,
